...
/**
 * This is the short named interface to the PrivilegedAccessor class. Use this
 * if the name "PrivilegedAccessor" is too long for your application. The only
 * difference to PrivilegedAccessor is that PA uses varargs.
 * 
