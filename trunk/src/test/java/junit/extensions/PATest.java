...
public class PATest {
    ...
    public final void testGetMethodSignatures() {
        ...
        testMethodSignatures = new HashSet<String>(Arrays.asList(new String[]{"void finalize()", "void wait(long, int)", "void wait(long)", "void wait()", "boolean equals(java.lang.Object)", "java.lang.String toString()", "int hashCode()", "java.lang.Class getClass()", "java.lang.Object clone()", "void registerNatives()", "void notify()", "void notifyAll()"}));
